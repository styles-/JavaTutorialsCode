 ...
 */
public class Deck {
	private Card[] cards = new Card[] { Card.ACE_OF_CLUBS, Card.TWO_OF_CLUBS,
			Card.THREE_OF_CLUBS, Card.FOUR_OF_CLUBS, Card.FIVE_OF_CLUBS,
			Card.SIX_OF_CLUBS, Card.SEVEN_OF_CLUBS, Card.EIGHT_OF_CLUBS,
			Card.NINE_OF_CLUBS, Card.TEN_OF_CLUBS, Card.JACK_OF_CLUBS,
			Card.QUEEN_OF_CLUBS, Card.KING_OF_CLUBS, Card.ACE_OF_DIAMONDS,
			Card.TWO_OF_DIAMONDS, Card.THREE_OF_DIAMONDS,
			Card.FOUR_OF_DIAMONDS, Card.FIVE_OF_DIAMONDS, Card.SIX_OF_DIAMONDS,
			Card.SEVEN_OF_DIAMONDS, Card.EIGHT_OF_DIAMONDS,
			Card.NINE_OF_DIAMONDS, Card.TEN_OF_DIAMONDS, Card.JACK_OF_DIAMONDS,
			Card.QUEEN_OF_DIAMONDS, Card.KING_OF_DIAMONDS, Card.ACE_OF_HEARTS,
			Card.TWO_OF_HEARTS, Card.THREE_OF_HEARTS, Card.FOUR_OF_HEARTS,
			...
			Card.ACE_OF_SPADES, Card.TWO_OF_SPADES, Card.THREE_OF_SPADES,
	...
	/**
	 * Create a <code>Deck</code> of 52 <code>Card</code> objects. Shuffle these
	 * objects.
	 */
	public Deck() {
	 ...
	 *
	 * @return the <code>Card</code> object at the top of the <code>Deck</code>
	 */
	public Card deal() {
	 ...
	 *
	 * @param card
	 *            <code>Card</code> object being put back
	 */
